...
public class InputsTest {
    ...
    @Test
    public void inputsChecks() {
        driver.get("https://the-internet.herokuapp.com/inputs");
        SoftAssert softAssert = new SoftAssert();
        driver.findElement(By.tagName("input")).sendKeys("1");
        driver.findElement(By.tagName("input")).sendKeys(Keys.ARROW_UP);
        softAssert.assertEquals(driver.findElement(By.tagName("input")).getAttribute("value"), "2");
    ...
    public void checkNotNumInputs() {
        driver.get("https://the-internet.herokuapp.com/inputs");
        SoftAssert softAssert = new SoftAssert();
        driver.findElement(By.tagName("input")).sendKeys("AAAAAA");
        driver.findElement(By.tagName("input")).sendKeys(Keys.ARROW_UP);
